...
# migrated to api/routers/groups.py: local-groups refresh and groups listing endpoints removed
...
# migrated to api/routers/groups.py: /api/groups/{group_id}/info endpoint removed
...
# migrated to api/routers/groups.py: /api/groups/{group_id} delete endpoint removed
